...
namespace BilliardFramework
{
	...
	public static class TextureManager
	{
		...
		static TextureManager()
		{
			...
			{
				Console.WriteLine("WARNING: TextureManager could not be created: " + exception.Message + " @ " + exception.Source);
			}
		}
		...
		public static void RemoveTexture(string name)
		{
			...
			{
				Console.WriteLine("WARNING: Failed to remove texture " + name + ": " + exception.Message);
			}
		...
		public static int GetTexture(string name)
		{
			...
			Console.WriteLine("WARNING: failed to get texture " + name);
